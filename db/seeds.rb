...
build = Build.create!({:project => web, :ref => "6223e7e3356d24b1c98e02986dcb576c2c7e7363", :state => "succeeded", :queue => "ci", :created_at => "2011-09-21 19:39:51", :updated_at => "2011-09-21 19:39:51"})
